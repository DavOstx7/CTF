...
def check_key(key, username_trial):
    ...
    if len(key) != len(key_full_template_trial):
        ...
        for c in key_part_static1_trial:
            ...
            i += 1
        print("~~~~~~~~~~~~~~~PASSED THE FOR C LOOP~~~~~~~~~~~~~~~")
        # TODO : test performance on toolbox container
        # Check dynamic part --v

        print("The key at the start is " + key)

        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[4]
        key = ''.join(k)
        print("Key after first change is: " + key)
        ...
        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[5]
        key = ''.join(k)
        print("Key after second change is: " + key)
        ...
        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[3]
        key = ''.join(k)
        print("Key after third change is: " + key)
        ...
        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[6]
        key = ''.join(k)
        print("Key after fourth change is: " + key)
        ...
        if key[i] != hashlib.sha256(username_trial).hexdigest()[6]:
            ...
            i += 1
        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[2]
        key = ''.join(k)
        print("Key after fifth change is: " + key)
        ...
        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[7]
        key = ''.join(k)
        print("Key after sixth change is: " + key)
        ...
        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[1]
        key = ''.join(k)
        print("Key after seventh change is: " + key)
        ...
        k = list(key)
        k[i] = hashlib.sha256(username_trial).hexdigest()[8]
        key = ''.join(k)
        print("Key after eigth change is: " + key)

        if key[i] != hashlib.sha256(username_trial).hexdigest()[8]:
            return False


        print("The key at the end is: " + key)
